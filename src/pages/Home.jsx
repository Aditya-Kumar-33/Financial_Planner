  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute inset-0 flex flex-col h-[200vh]">
        ...
        <div className="flex flex-col items-center text-center space-y-6 mt-[25vh]">
          <h1 className="text-white text-5xl font-bold font-manrope">
            Finance Management Made Simple
          </h1>
          <h1 className="text-white text-3xl font-bold font-spaceGrotesk">
