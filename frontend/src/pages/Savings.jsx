...
const Savings = () => {
  ...
  const expenses = expensesInfor.reduce(
  ...
  return (
    ...
    >
      <div className="h-[85%] w-[100%] mt-30 grid grid-cols-10">
        {/* Left Sidebar with Pie Chart */}
        <div
          className="mt-[3vh] ml-[2vh] col-span-3
          ...
          <div className="grid grid-cols-3 h-[120px]">
            {[
              ...
              <div key={index} className="flex justify-center items-center">
                ...
                >
                  <div className={`text-3xl ${item.color}`}>{item.value}</div>
                  <div>{item.label}</div>
                </div>
              </div>
            ))}
          ...
          <div className="w-full flex flex-col items-center gap-2">
            ...
            {expensesInfor.map((expense, index) => (
              ...
              >
                ...
                <div className="flex-1 text-center text-blue-400 text-xl font-bold">
                  ₹{expense.Amount}
                </div>
